...
/*! 
  \file 
  \brief The PNM graphics format I/O function definitions 
...
/*!
  ...
  This interface proposes input/output functions for images in the raw formats (type 'P4', 'P5' and 'P6').
...
*/
bool pnm_info( const string & filename, 
	       char & pnm_type, 
	       int & width, 
	       int & height, 
	       int & max_val,
...
/*! 
  \ingroup image
  \brief Read the entire graymap into the matrix \a m or return false if the function failed.
  \param filename The name of the file from which the image is retrieved
  \param m The matrix in which the image will be stored
  \param comments This string variable is used to retrieve the comments of the file
*/
...
/*!
  \ingroup image
  \brief Read a pgm file of name filename and return the corresponding matrix of integers.
...
bool pgm_write(const string & filename, 
	       const imat &m,
	       const string & comments = "Generated by IT++ (http://itpp.sourceforge.net)" );
...
/*! 
  ...
  The image is retrieved as a set of three matrices, each of whom is a plan of RGB component.
...
/*! 
  ...
  The parameters \a r1, \a r2, \a c1 and \a c2 are the rows and columns (inclusive) of the subimage.
*/
...
/*! 
  ...
  \param max_val The maximum value of a component. This quantity should be lower than 255 (raw type).
*/
...
/*! 
  ...
  Similarly to \a double_min, values greater than \a double_max will be set to double_max
*/
...
/*! 
  ...
  \param m The matrix of real. The components are assumed to be between 0 and 1,
  and will be scaled by factor max_val in the output matrix.
  \param max_val The maximum value for the output matrix. 
  This value is usually set to 255.
  \param double_min The value on which the integer value 0 will be mapped
  \param double_max The value on which the integer value \a max_val will be mapped
*/
