 ...
 *                                   IT++                                    *
 *---------------------------------------------------------------------------*
 * Copyright (c) 2003 by Tobias Tynderfeldt                                  *
 *                                                                           *
...
/*! 
  ...
  A \c Circular_Buffer<type> can contain any type and it is not possible 
  to initialize and pre-compile all types that might be put into a \c Circular_Buffer.
